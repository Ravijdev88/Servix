  ...
  <div class="row">
    <div class="card mx-auto">
      <div class="card-body p-4">
        <h4 class="" style="font-size: 30px"><b style="color:#8B0000">V</b>erification Complete</h4>
        <p class="mt-3">Your account will be ready within 24hours. Thank you for choosing Servix</p>
