...
<div class="container-fluid" style="background-color: #8b0000">
  <div class="row py-5">
    <div class="text-white col-md-6 col-lg-8 col-sm-6">
      <p class="text-center" style="font-size: 18px">2000+ People trusted Servix! Be one of them today </p>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-6">
      <a href="get_started.php" class="btn ml-3 px-4" style="background-color: #efefef; color:#8b0000; border-radius: 50px">Get Started</a>
    </div>
  </div>
</div>
<!------footer----->
